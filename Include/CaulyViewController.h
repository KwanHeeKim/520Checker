...
// 배너광고 뷰 회전
// 게임과 같이 가로 뷰를 쓰는 어플일 경우 아래 메소드를 이용하여 카울리 뷰를 적절히 회전 시켜서 보여 줄 수 있습니다.
// 카울리 뷰를 요청하신 뒤 호출하여야 적용이 됩니다.
// 단, 뷰를 회전시킬경우 회전 결과에 따라 x, y 축이 바뀌게 되므로 위치 조정에 주의 하시기 바랍니다.
// 다음 중 하나를 인자로 넘겨주시면 됩니다.
...
+ (BOOL) rotateCaulyBannerView:(UIInterfaceOrientation)orientation;
